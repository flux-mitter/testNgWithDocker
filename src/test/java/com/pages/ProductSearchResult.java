...
public class ProductSearchResult extends BasePage {
	...
	private By priceOfProductsSorted(String product) {
		return By.xpath("//h2/a/span[contains(text(),'" + product
				+ "') and not(contains(text(),'Pro')) and not(contains(text(),'Plus'))]/../../../following-sibling::div//span[@class='a-price']/span[contains(text(),'₹')]");
	}
